...
интерактивных областях. Пропорцию можно выбрать: `1:2` или `2:1`.
...
> Статус: версия `0.4.0`, тестируется на DiLink 5 / Android 12. Перед поездкой
...
- две области с переключаемой пропорцией `1:2` или `2:1`;
