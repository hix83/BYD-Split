...
- закрытие приложения перетаскиванием его карточки в корзину после
  двухсекундного удержания по центру области; процесс и фоновые службы
  приложения при этом полностью останавливаются;
...
- встроенный выбор приложений и переход к настройкам, открываемые свайпом
  вниз за видимый верхний язычок в каждой панели; шторка следует за пальцем
  и фиксируется открытой после протягивания более чем на треть высоты;
- модальное окно настроек без остановки приложений в панелях;
- отключаемый полноэкранный режим со скрытием системных панелей DiLink;
...
- циклическое переключение приложений долгими нажатиями стрелок руля:
  левая стрелка листает левую панель назад, правая — правую вперёд;
...
- включить или выключить полноэкранный режим; скрытые системные панели
  временно возвращаются свайпом от края экрана;
